...
<!--                                                    <li>
                                    ...
                                    <li class="adomx-dropdown col-auto">
                                        ...
                                        <span class="avatar">
                                            ...
                                            <span class="name"><?php echo $admin->username;?></span>
                                        ...
                                        <div class="adomx-dropdown-menu dropdown-menu-user">
                                            <div class="head">
                                                <h5 class="name"><a href="#"><?php echo $admin->username;?></a></h5>
                                                <a class="mail" href="#"><?php echo $admin->email;?></a>
                                            </div>
                                            <div class="body">
<!--                                                <ul>
                ...
                <nav class="side-header-menu" id="side-header-menu">
                    <ul>
                     ...
                     <li class="has-sub-menu"><a href="#"><i class="ti-user"></i> <span>Account</span></a>
                            <ul class="side-header-sub-menu">
                                <li><a href="verify"><span>Verify</span><?php if (intval($admin->verified)) { ?> <span class="badge badge-outline badge-success">Verified</span><?php } ?></a></li>
...
<!--                 Top Selling Country Start 
                ...
                <div class="col-lg-12 col-12 mb-30">
                    <div class="box">
                        <div class="box-head">
                            <h4 class="title">Active investment requests</h4>
                        </div>
                        <div class="box-body">
                            <table class="table">
                                <thead>
                                ...
                                <tbody>
                                    <?php foreach ($investment_requests as $request) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url();?>admin/accept-investment-request/<?php echo $request->id;?>" class="button button-outline button-info"><span>Accept</span></a>
