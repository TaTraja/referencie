...
<body>
    ...
    <main class="container">
        ...
        <div class="body">
            <h2>Žiadosť o Vklad </h2>
            
            <p> <?php echo $user->username;?> podal žiadosť o vklad .<br>Ten treba potvrdiť v admin dashboarde<br>
            <br><h4>INFO</h4></p>
            <p>Name: <?php echo $user->first_name;?> <?php echo $user->last_name;?></p>
            <p>Email: <?php echo $user->email;?></p>
            <p>Deposit in USD: <>PHP WITHDRAWAL USD HERE</p>
            <p>Selected product: <>PHP WALLET HERE</p>
