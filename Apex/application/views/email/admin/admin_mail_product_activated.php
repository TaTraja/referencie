...
<head>
    ...
    <title> ADMIN APEX Future [Product Activated] </title>
    <style>body{
...
<body>
    ...
    <main class="container">
        ...
        <div class="body">
            <h2>Apex Future - Product activated</h2>
            
            <p>Dear <?php echo $user->username;?>,<br>
            we are happy to inform you about product activation.<br>Thank you for your trust in APEX Future.<br>
            <br><h4>Product confirmation</h4></p>
        ...
        <p>You received this email because we activated our product for You.</p>
