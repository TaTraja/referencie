...
<head>
    ...
    <title>APEX Future [Withdrawal-confirmation] </title>
    <style>body{
...
<body>
    ...
    <main class="container">
        ...
        <div class="body">
            <h2>APEX Future - Withdrawal Confirmation </h2>
            
            <p> Dear <?php echo $user->username;?>,<br>Your withdrawal proposal has been processed.<br>Thank you for your patience.<br>
