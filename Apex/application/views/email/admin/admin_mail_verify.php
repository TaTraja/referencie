...
<head>
    ...
    <title>ADMIN APEX Future [Verifikacia noveho usera </title>
    <style>body{
...
<body>
    ...
    <main class="container">
        ...
        <div class="body">
            <h2>Verifikacia noveho klienta</h2>
            
            <p> <?php echo $user->username;?>,
            <br>sa chce verifikovať</p>
            <p>Verifikáciu treba overiť v admin dashboarde</p>
