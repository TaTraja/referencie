...
<head>
    ...
    <title>Welcome to APEX Future [Registration] </title>
    <style>body{
...
<body>
    ...
    <main class="container">
        ...
        <div class="body">
            <h2>Welcome to APEX Future</h2>
            
            <p> Dear <?php echo $user->username;?>,<br>Thank you for choosing <i>APEX Future!</i><br> We are happy to inform you about next step. <br>
            <br> You need to complete Verification process.</p>
            <p>To complete Verification, please, continue to Dashboard</p>
