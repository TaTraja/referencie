...
<head>
    ...
    <title>APEX Future [Withdrawal] </title>
    <style>body{
...
<body>
    ...
    <main class="container">
        ...
        <div class="body">
            <h2>APEX Future - Withdrawal </h2>
            
            <p> Dear <?php echo $user->username;?>,<br>Your withdrawal proposal is being processed.<br>Thank you for your patience.<br>
            <br><h4>Sumary</h4></p>
            ...
            <p><small>We are going to process this within 24 hours. You will be contacted via email after transaction is completed </small></p>
    ...
    <footer class="container">
        ...
        <p>You received this email because you've sent withdrawal proposal, which is being processed right now .</p>
