...
<head>
    ...
    <title>APEX Future [Deposit] </title>
    <style>body{
...
<body>
    ...
    <main class="container">
        ...
        <div class="body">
            <h2>APEX Future - deposit </h2>
            
            <p> Dear <?php echo $user->username;?>,<br>Your deposit proposal is being processed.<br>Once approved we are going to contact you with payment information.<br>
                <br>After payment is recieved, your Product will be activated.<br>
            <br><strong><h4>Sumary</h4></strong></p>
            <p>Name: <?php echo $user->first_name;?> <?php echo $user->last_name;?></p>
            <p>Email: <?php echo $user->email;?></p>
            <p>Deposit in USD: <>PHP DEPOSIT USD HERE</p>
            <p>Selected product: <>PHP SELECTED PRODUCT HERE</p>
